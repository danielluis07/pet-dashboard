...
import { useEditProduct } from "@/queries/products/use-edit-product";
...
type ProductsRequestType = InferResponseType<
...
type Props = {
  id: string;
  product: ProductsRequestType;
  pets: PetsRequestType[];
  categories: CategoriesRequestType[];
};

export const EditProductForm = ({ product, pets, categories, id }: Props) => {
