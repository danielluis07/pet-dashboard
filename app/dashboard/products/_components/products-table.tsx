...
type ProductsDataTableProps<TData, TValue> = {
...
export function ProductsDataTable<TData, TValue>({
  ...
  const [ConfirmDialog, confirm] = useConfirm(
    "Tem certeza?",
    "Você está prestes a deletar os produtos selecionados"
  );
      ...
      <div className="flex items-center justify-between py-4">
        ...
        <div>
          <div className="flex space-x-2">
            <Button
              onClick={() => router.push("/dashboard/products/new-product")}>
              Adicionar novo <CirclePlus />
            </Button>
